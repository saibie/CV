...
\usepackage{etoolbox} % [중요] 매크로 추가를 위한 패키지
...
\newcommand\addproject[9]{
    \appto\myprojs{
        ...
        $\circ$ 사업비 : ₩#5 \\
        $\circ$ 기간 : #7 \\
        $\circ$ 지원기관 : #8 \\ \medskip\par
    }
    \appto\myprojseng{
        \textbf{#2} (#4) \\
        $\circ$ Fund : \$#6 \\
        $\circ$ Period : #7 \\
        $\circ$ Support : #9 \\ \medskip\par
    }
}
...
\newcommand\myedueng{
	...
	\subsection*{M.S., Pusan National University \hfill 2010.03 -- 2012.02}
