...
\newcommand{\addpaper}[5]{
	\ifx\mypapers\empty
	\edef\mypapers{\unexpanded\expandafter{\years{#1}#2, ``#3'', {\it #4}, #5.}}
	\else
	\edef\mypapers{\unexpanded\expandafter{\mypapers \par \years{#1}#2, ``#3'', {\it #4}, #5.}}
	\fi
}
...
\newcommand\profile{
	...
	부산광역시 부산진구 자유평화로37번길 67 2603호 % Address
	\medskip % Whitespace
...
\newcommand\profileeng{
	...
	47362, No.2603, 67, Jayupyeonghwa-ro 37beon-gil, Busanjin-gu, Busan, Republic of Korea % Address
	\medskip % Whitespace
...
%}
\addpaper{2013}
{Seo, Sang-Hyup, Seo, Jong-Hyun, and Kim, Hyun-Min}
...
\addpaper{2018}
{Seo, Sang-Hyup, Seo, Jong-Hyeon, and Kim, Hyun-Min}
{A Modified Newton Method for a Matrix Polynomial Equation Arising in Stochastic Problem}
{Electron. J. Linear Algebra}
{34, 500--513, 2018}

\addpaper{2019}
{Kim, Taehyeong, Sang-Hyup Seo, and Hyun-Min Kim}
{On Newton's Method for Solving a System of Nonlinear Matrix Equations}
{East Asian Math. J.}
{35(3), 341--349, 2019}

\addpaper{2020}
{Seo, Sang-hyup, and Jong-Hyeon Seo}
{Convergence of relaxed Newton method for order-convex matrix equations}
{Comput. Appl. Math.}
{39(1), 1--17, 2020}

\addpaper{2023}
{Na Hyeon Lee, Seon Hee Kim, Sang-Hyup Seo, Byeong-Jun Kim, Chi-Seung Lee, Gil Hwan Kim, Sung Jin Park, Seon Hyun Kim, Dong Yeon Ryu, Ho Hyun Kim, Sang Bong Lee, Chan Ik Park, and Jae Hun Kim}
...
\addpaper{2023}
{Giphil Cho, Young Jin Kim, Sang-hyup Seo, Geunsoo Jang, and Hyojung Lee}
